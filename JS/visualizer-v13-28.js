(function () {
        ...
        if (config.dbTheme && config.dbTheme !== 'default') {
            ...
            const css = `
                <style id="acu-db-beautify">
                    ...
                    .auto-card-updater-popup input, .auto-card-updater-popup select, .auto-card-updater-popup textarea {
    ...
    const addStyles = () => {
        ...
        const styles = `
            <style id="${SCRIPT_ID}-styles">
                ...
                .acu-action-btn { flex: 1; height: 35px; display: flex; align-items: center; justify-content: center; background: var(--acu-btn-bg); border-radius: 8px; color: var(--acu-text-sub); cursor: pointer; border: 1px solid transparent; transition: all 0.2s; font-size: 12px; }
                ...
                .acu-panel-title { font-weight: bold; color: var(--acu-text-main); display: flex; align-items: center; gap: 8px; white-space: nowrap; font-size: calc(var(--acu-font-size) + 2px); }
                ...
                .acu-header-btn { width: 31px; height: 31px; display: flex; align-items: center; justify-content: center; border-radius: 8px; border: 1px solid var(--acu-border); background: var(--acu-btn-bg); color: var(--acu-text-sub); cursor: pointer; transition: all 0.2s; font-size: 14px; flex-shrink: 0; }
                ...
                .acu-dash-title { font-size: var(--acu-font-size); font-weight: bold; color: var(--acu-highlight); border-bottom: 1px dashed var(--acu-border); padding-bottom: 8px; margin-bottom: 4px; display: flex; justify-content: center; align-items: center; }
                ...
                .acu-tab-btn { padding: 6px 12px; cursor: pointer; font-size: var(--acu-font-size); font-weight: bold; color: var(--acu-text-sub); border-bottom: 2px solid transparent; transition: all 0.2s; flex: 1; text-align: center; }
                ...
                .acu-editable-title { cursor: pointer; border-bottom: 1px dashed transparent; transition: all 0.2s; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: calc(var(--acu-font-size) + 2px); font-weight: 800; text-align: center; width: 100%; padding: 2px 5px; border-radius: 4px; }
    ...
    const showSettingsModal = () => {
        ...
        <style>
            ...
            .acu-label-main { font-size: 13px; font-weight: bold; color: var(--acu-text-main); }
            ...
            .acu-bottom-spacer {
                ...
                color: var(--acu-text-sub); font-size: 8px;
            ...
            <div class="acu-edit-overlay">
                ...
                <div class="acu-edit-dialog acu-theme-${config.theme}">
                     <div class="acu-edit-header">
                        <span style="font-size:15px; font-weight:bold;">设置选项</span>
                    ...
                    <div class="acu-settings-content" style="flex: 1; overflow-y: auto; padding: 20px;">
                        ...
                        <div style="font-size:11px; font-weight:bold; color:var(--acu-highlight); margin:0 0 8px 10px;">外观与显示</div>
                        ...
                        <div style="font-size:11px; font-weight:bold; color:var(--acu-highlight); margin:0 0 8px 10px;">功能开关</div>
                        <div class="acu-settings-group">
                        ...
                        <div style="font-size:11px; font-weight:bold; color:var(--acu-highlight); margin:0 0 8px 10px;">尺寸调节</div>
                        <div class="acu-settings-group">
                            <div class="acu-control-row">
                            ...
                            <div class="acu-control-row">
                                ...
                                <div class="acu-input-col" style="flex:1; padding-left:20px;">
                                    <input type="range" id="cfg-font" class="acu-nice-slider" min="10" max="20" step="1" value="${config.fontSize}" style="width:100%">
                                </div>
                            </div>
                            <div class="acu-control-row">
                                ...
                                <div class="acu-input-col" style="flex:1; padding-left:20px;">
                                    <input type="range" id="cfg-opt-font" class="acu-nice-slider" min="10" max="20" step="1" value="${config.optionFontSize || 13}" style="width:100%">
                                </div>
                            </div>
                            <div class="acu-control-row">
                        ...
                        <div style="font-size:11px; font-weight:bold; color:var(--acu-highlight); margin:0 0 8px 10px;">表格显示偏好 <span style="font-weight:normal; color:var(--acu-text-sub); margin-left:8px; font-size:10px;">点击 <i class="fa-solid fa-eye"></i> 切换显示/隐藏，开启 <i class="fa-solid fa-toggle-on" style="color:var(--acu-highlight)"></i> 启用倒序 (新内容在前)</span></div>
        ...
        if ($target && $target.length) {
            ...
            const $icon = $container.find('.acu-opt-toggle-icon');
    ...
    const renderDashboard = (tables) => {
        ...
        const defaults = {
            'slot_top': {isEmpty:true}, 'slot_tab1': {isEmpty:true}, 'slot_tab2': {isEmpty:true}, 'slot_tab3': {isEmpty:true}, 
            'slot_right1': {isEmpty:true}, 'slot_right2': {isEmpty:true}, 'slot_right3': {isEmpty:true}, 
            'slot_top_2': {isEmpty:true}, 'slot_top_3': {isEmpty:true}, 
            'slot_tab1_2': {isEmpty:true}, 'slot_tab1_3': {isEmpty:true}, 
            'slot_right2_2': {isEmpty:true}, 'slot_right2_3': {isEmpty:true}, 
            'slot_right3_2': {isEmpty:true}, 'slot_right3_3': {isEmpty:true}
        };
        ...
        // [Inserted Auto-Config Logic]
        let _cfgChanged = false;
        const _autoSetup = [
            { id: 'slot_top', kw: '全局数据', rule: 'kv', cols: [1, 2] },
            { id: 'slot_tab1', kw: '主角信息', rule: 'kv' },
            { id: 'slot_right1', kw: '重要人物', rule: 'capsule', col: 1 },
            { id: 'slot_right2', kw: '背包', rule: 'capsule', col: 1 },
            { id: 'slot_right2_2', kw: '技能', rule: 'capsule', col: 1 },
            { id: 'slot_right3', kw: '任务', rule: 'capsule', col: 1, capCols: 2 },
            { id: 'slot_right3_2', kw: '地点', rule: 'capsule', col: 1, capCols: 2 }
        ];
        _autoSetup.forEach(s => {
            if (!dashConfig[s.id]) {
                ...
                if (k && tables[k]) {
                    const t = tables[k];
                    const entry = { isEmpty: false, title: k, text: k, rule: s.rule };
                    let valid = false;
                    if (s.rule === 'kv' && t.rows && t.rows.length) {
        ...
        const renderFirstRowAllCols = (slotId) => {
            ...
            // 3. 自定义列选择 (如果配置了showCols则只显示选定列，否则显示所有)
            ...
            return `<div class="acu-dash-char-info ${slotId.startsWith('slot_top') ? 'acu-dash-top-kv' : ''}" style="display:flex; flex-direction:column; gap:8px;">${itemsHtml}</div>`;
        };

        // 规则一：表格总览 (胶囊) - 支持自定义展示列
        const renderSecondColCapsules = (slotId) => {
            ...
            const customStyle = (noLimitSlots.includes(slotId) ? '' : 'max-height: 250px; height: auto;') + gridStyleOverride;

            return `<div class="acu-dash-npc-grid" style="${customStyle}">${itemsHtml}</div>`;
        };
        ...
        const renderSlotWrapper = (slotId, contentHtml) => {
             ...
             return `
                <div class="acu-dash-card" style="position:relative; width:100%; box-sizing:border-box;">
                    ${editBtn}
        ...
        // 三合一卡槽渲染辅助函数
        const render3In1Group = (groupId, slotIds, minHeight) => {
            let visibleIds = slotIds.filter(id => !getSlotCfg(id).isEmpty);
            // 编辑模式下显示所有卡槽以便配置（或者显示已配置的+所有空的？为了简洁，编辑模式下视为所有都可见，或者至少让空的有机会被点到）
            // 需求：未配置的卡槽只有在编辑模式下可见
            ...
            // 如果只有一个可见卡槽，保持原有单卡槽效果
            if (visibleIds.length === 1) {
                const sid = visibleIds[0];
                return renderSlotWrapper(sid, renderSlotContent(sid), minHeight);
            }
            ...
            // 手动构建容器，模拟 renderSlotWrapper 的样式但不包含标题栏（因为标题在 Tab Header 里）
            // 注意：这里需要 acu-dash-card 类来保持风格
            return `<div class="acu-dash-card" style="${minHeight ? 'min-height:'+minHeight+';' : ''} width:100%; box-sizing:border-box; display:flex; flex-direction:column; padding:0; overflow:hidden; gap:0;">
                <div style="padding:10px 16px 0 16px;">${header}</div>
                <div style="padding:6px 16px 16px 16px; flex:1; overflow-y:auto;">${body}</div>
            </div>`;
        };

        // 修改 renderSlotWrapper 以支持 minHeight 透传 (虽然原函数只接受 slotId, contentHtml)
        // 由于原 renderSlotWrapper 定义在上方且未被正则覆盖，这里我们直接在 render3In1Group 里处理单卡槽逻辑时调用原 renderSlotWrapper
        // 注意：原 renderSlotWrapper 没有 minHeight 参数，我们通过 style 注入或者修改原函数。
        // 为简单起见，我们在 renderSlotWrapper 的返回值外层包裹或修改 style 较为困难，
        // 但观察原代码，renderSlotWrapper 返回的是 HTML 字符串。
        // 我们可以简单地针对 Tab 组单独处理样式。对于单卡槽，保持默认即可（通常自适应）。
        ...
        const html = `
            ...
            <div class="acu-panel-content" style="overflow-y:auto; padding:12px;">
                <div class="acu-dash-container" style="display:flex; flex-direction:column; gap:16px; height:auto; overflow:visible;">

                    <!-- 顶部区域 (三合一) -->
                    ${render3In1Group('grp_top', ['slot_top', 'slot_top_2', 'slot_top_3'])}

                    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap:16px;">

                        <!-- 左侧区域 (三合一) -->
                        ${render3In1Group('grp_left', ['slot_tab1', 'slot_tab1_2', 'slot_tab1_3'])}

                        <div style="display:flex; flex-direction:column; gap:16px;">
                            <!-- 右侧中部区域 (保留原 tab2/tab3 逻辑，改为三合一调用，高度设为350px) -->
                            ${render3In1Group('grp_right_mid', ['slot_right1', 'slot_tab2', 'slot_tab3'])}

                            <!-- 右侧下方区域1 (三合一) -->
                            ${render3In1Group('grp_right_btm1', ['slot_right2', 'slot_right2_2', 'slot_right2_3'])}

                            <!-- 右侧下方区域2 (三合一) -->
                            ${render3In1Group('grp_right_btm2', ['slot_right3', 'slot_right3_2', 'slot_right3_3'])}
                        </div>
                    </div>
                </div>
            </div>
...
return html;
    ...
    const bindEvents = (tables) => {
        ...
        const bindDynamicContentEvents = () => {
            ...
            $('.acu-tab-btn').off('click').on('click', function(e) {
                 e.stopPropagation();
                 // [Fix] 改用索引切换，避免 document.getElementById 在特定环境下查找失败导致内容消失
        ...
        const bindDataAreaEvents = () => {
            ...
            $('#acu-btn-dash-edit').off('click').on('click', (e) => { e.stopPropagation(); isDashEditing = !isDashEditing; renderInterface(); });
        ...
        const setup = (selector) => {
             ...
             $items.on('click.swap', function(e) { 
                 ...
                 if (!selectedEl) {
                     ...
                     // 确保只在同一容器内的元素间互换（防止 tab 和 action 按钮混换）
    ...
    const showDashSlotSettings = (slotId) => {
        ...
        const dialog = $(`
            <div class="acu-edit-overlay">
                <div class="acu-edit-dialog acu-theme-${config.theme}" style="max-width: 400px; height: auto; max-height: 90vh; overflow: visible;">
        ...
        const refreshOptions = () => {
            ...
            if (table.headers) {
                table.headers.forEach((h, idx) => {
                    if (idx === 0) return;
                    // 如果 showCols 未定义，默认全选 (视觉上)；如果定义了，按定义选。
